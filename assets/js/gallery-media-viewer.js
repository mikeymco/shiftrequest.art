// Media viewer functionality with URL state
(function() {
	// Constants and DOM elements
	const DOM = {
		overlay: document.getElementById('gallery-media-viewer'),
		image: document.getElementById('gallery-media-viewer__image'),
		video: document.getElementById('gallery-media-viewer__video'),
		caption: document.getElementById('gallery-media-viewer__caption'),
		loadingIndicator: document.getElementById('gallery-media-loading-indicator'),
		links: document.querySelectorAll('.gallery-tile--media'),
		closeBtn: document.querySelector('.gallery-media-viewer__close'),
		nextBtn: document.querySelector('.gallery-media-viewer__next'),
		prevBtn: document.querySelector('.gallery-media-viewer__prev')
	};
	...
	function setupEventListeners() {
		...
		DOM.overlay.addEventListener('click', hideViewer);
